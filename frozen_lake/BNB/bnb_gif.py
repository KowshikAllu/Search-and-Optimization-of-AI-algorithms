...
try:
    with open("successful_path.txt", "r") as f:
    ...
    print("Error: 'successful_path.txt' not found. Run bnb.py first to generate a successful path.")
    exit()
...
ax.set_title("Branch and Bound Path Visualization")
...
plt.tight_layout()
ani.save("bnb_frozenlake.gif", writer='pillow', fps=1.5, dpi=100)
